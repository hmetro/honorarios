...
import MenuPanelHonorarios from '../menu/panelHonorarios';
import App from '../app';



const InicioHonorarios = {
    oninit: () => {
        if (!Auth.isLogin()) {
    ...
    oncreate: () => {
        document.title = "Mis Honorarios | " + App.title;
        _Main();
    },
    view: () => {
        return [
            m(HeaderPrivate),
            m(MenuPanelHonorarios),
        ];
    },
...
export default InicioHonorarios;