<?php  
	class planillas_pago
	{
		...
		function validar_transaccion($vln_proveedor,$vlc_numero_transaccion)
		{
		...
		function consultar_numero_referencia($vln_proveedor,$vgn_numero_transaccion)
		{
		...
		function consultar_transaccion_fm($vlc_proveedor,$vgc_fecha_transaccion,$vgn_numero_transaccion)
		{
		...
		function facturas_planilla($vlc_proveedor,$vgc_fecha_transaccion,$vgn_numero_transaccion)
		{
			$vlc_sql="select a.fecha,
					       a.serie_fisico||'-'||a.no_fisico factura,
					       a.numero_prefactura prefactura,
...
<?php
		...
		function total_facturas_planilla($vln_proveedor,$vgn_numero_referencia)
		{
...
<?php 
		...
		function copagos_planilla($vlc_numero_referencia)
		{
...
<?php 
		...
		function anticipios_planilla($vlc_transaccion_fm, $vgc_fecha_transaccion)
		{
...
<?php 
		...
		function retencion_anticipo_planilla($vlc_numero_referencia)
		{
...
<?php 
		...
		function descuentos_planilla($vln_proveedor, $vlc_numero_referencia)
		{
...
<?php 
		...
		function formas_pago_planilla($vln_proveedor, $vlc_numero_referencia)
		{
...
<?php 
		...
		function proximo_debito_planilla($vln_proveedor)
		{
...
<?php 
		...
		function cabecera_comprobante($vlc_numero_transaccion)
		{
...
<?php 
		...
		function detalle_comprobante($vgc_proveedor,$vgn_numero_transaccion)
		{
