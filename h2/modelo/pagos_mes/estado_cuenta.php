<?php  
	...
	{
		private $conexion;
		public $vln_suma_fa_entregada_factura_total = 0.00;
		public $vln_suma_fa_entregada_copago_total = 0.00;
		public $vln_suma_fa_entregada_tarjeta_total = 0.00;
		public $vln_suma_fa_entregada_contribucion_total = 0.00;
		public $vln_suma_fa_entregada_descuento_total = 0.00;
		public $vln_suma_fa_entregada_saldo_total = 0.00;
		public $vln_suma_fa_recibida_pagos_total = 0.00;
		public $vln_suma_fa_recibida_retencion_total = 0.00;
      ...
      oci_execute($vlc_resultados);
		...
		function facturas_entregadas($vlc_proveedor,$vgc_fecha_desde,$vgc_fecha_hasta)
		{
			$vlc_sql="SELECT   A.no_prove codigo_medico, 
                               ...
                               tr.tipo_doc,tr.no_fisico,tr.fecha     --AUMENTAR
                        FROM ARCPMD A, ARCPTD B, ARCPMP C,
--AUMENTAR TODO LO AMARILLO
                        (SELECT x.no_docu docu_tr,r.tipo_doc,r.no_docu,d.fecha, d.no_fisico
                        ...
                        group by tr.tipo_doc,tr.no_docu,tr.fecha , tr.no_fisico,  --AUMENTAR
...
?>
							<tr align="left">
								...
								<td align="right"><?php echo $vlc_respuesta[14]; ?></td>
...
<?php
				$this->vln_suma_fa_entregada_factura_total += $vlc_respuesta[14];
				$this->vln_suma_fa_entregada_copago_total += $vlc_respuesta[11];
				$this->vln_suma_fa_entregada_tarjeta_total += $vlc_respuesta[10];
				$this->vln_suma_fa_entregada_contribucion_total += $vlc_respuesta[12];
				$this->vln_suma_fa_entregada_descuento_total += $vlc_respuesta[11];
				$this->vln_suma_fa_entregada_saldo_total += $vlc_respuesta[15];

			}
?>		
							<tr >
								<td colspan="6"></td>
								<td  style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo round( $this->vln_suma_fa_entregada_factura_total,2); ?></b></td>
								<td style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo round( $this->vln_suma_fa_entregada_copago_total,2); ?></b></td>
								<td style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo $this->vln_suma_fa_entregada_tarjeta_total; ?></b></td>
								<td style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo $this->vln_suma_fa_entregada_contribucion_total; ?></b></td>
								<td style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo $this->vln_suma_fa_entregada_descuento_total; ?></b></td>
								<td style="border-top: 0.3px solid #625A58; background-color: #cdd8d3;" align="right" ><b><?php echo $this->vln_suma_fa_entregada_saldo_total; ?></b></td>
							</tr>
						</tbody>
					</table>
<?php				
		...
		function pagos_recibidos($vlc_proveedor,$vgc_fecha_desde,$vgc_fecha_hasta)
		{
			$vlc_sql="
						select a.*,b.*,c.*
        				  ...
        				  ph.comp_ret,
        				  (SELECT FUN_PH_FACT_PAGADAS_APP('$vlc_proveedor',ph.tipo_doc,ph.no_docu) FROM DUAL)
        				     --NO RETENCION
...
?>
							<tr align="left">
								...
								<td align="left"><?php echo $vlc_respuesta[14]; ?></td>
								<td align="center"><?php echo $vlc_respuesta[21]; ?></td>
								<td align="right"><?php echo $vlc_respuesta[22]; ?></td>
								<td align="left" ><?php echo " "; ?></td>
								<td align="right"><?php echo " "; ?></td>
							</tr>
<?php 			
				$this->vln_suma_fa_recibida_pagos_total += $vlc_respuesta[7];
				$this->vln_suma_fa_recibida_retencion_total += $vlc_respuesta[22];
			}
?>							<tr>
								<td colspan="2"></td>
								<td style="border-top: 0.3px solid #625A58;" align="right">Total Pagos:</td>
								<td  style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo round( $this->vln_suma_fa_recibida_pagos_total,2); ?></b></td>
								<td colspan="2"></td>
								<td style="border-top: 0.3px solid #625A58;" align="right">Total retención:</td>
								<td  style="border-top: 0.3px solid #625A58;" align="right"><b><?php echo round( $this->vln_suma_fa_recibida_retencion_total,2); ?></b></td>
								<td colspan="1"></td>
							</tr>
						</tbody>
					</table>	
<?php				
		...
		function facturas_abiertas($vlc_proveedor,$vgc_fecha_desde,$vgc_fecha_hasta,$vlc_primer_dia)
		{
				$vlc_sql="SELECT nvl(decode(a.tipo_doc,'FH','HONORARIOS MÉDICOS','FO','SOAT','FA','SUMINISTROS','DV','DIVIDENDOS','FM',
							              cc_nombre_paciente(a.hist_clinica_pac, a.numero_prefactura)),a.detalle) paciente, --AUMENTAR APELLIDOS Y NOMBRES DEL PACIENTE
							A.no_prove codigo_medico_fa, 
							...
							FROM ARCPMD A, ARCPTD B, ARCPMP C
							WHERE A.NO_CIA = '01'
              AND TRUNC(A.FECHA) < '$vlc_primer_dia'  
							--and trunc(a.fecha) >= '01/dic/2019'
							--and trunc(A.fecha)>='$vgc_fecha_desde'
							--and trunc(A.fecha)<='$vgc_fecha_hasta'
...
?>	
								<tr align="left">
									<td align="center"><?php echo $vlc_respuesta[3]; ?></td>	
									<td align="right"><?php echo $vlc_respuesta[4]; ?></td>
									<td align="center"><?php echo $vlc_respuesta[6]; ?></td>
									<td align="center"><?php echo $vlc_respuesta[2]; ?></td>
									<td align="left"><?php echo $vlc_respuesta[0]; ?></td>
									<td align="left"><?php echo $vlc_respuesta[5]; ?></td>
									<td align="center"><?php echo $vlc_respuesta[10]; ?></td>
								</tr>
<?php	
				}
?>		
