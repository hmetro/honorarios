...
<head>
	...
	<link rel="stylesheet" href="vista/css/estilos_sistema.css?v=3">
	<link rel="stylesheet" href="vista/css/estilos_telefono.css?v=3">
...
<body>
	...
	<input type="hidden" name="CodigoProveedorHeader" id="CodigoProveedorHeader" value="<?php echo $_SESSION['vgc_codigo']; ?>">
	...
	<div class="container navbar_general">
		<header>
					...
					<div class="collapse navbar-collapse" id="menu-navbar">
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu color_menu_nav">
									...
									<li class="menu_subdatos">
										<a href="#" data-toggle='modal' data-target='#mi_perfil' class="letra_color"><span id="icono_menu" class="glyphicon glyphicon glyphicon-cog"></span> Mi perfil</a>
									</li>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="buton">
									<div class="text letra_color">
										<span id="icono_menu" class="glyphicon glyphicon-list-alt"> </span><b> Facturas</b>
										<span class="caret"></span>
									</div>
								</a>
								<ul class="dropdown-menu color_menu_nav">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu color_menu_nav">
									...
									<li class="menu_subdatos">
										<a href="http://<?php echo $vlc_dominio . "/" . $vlc_proyecto; ?>/descuento_honorario" class="letra_color"><span id="icono_menu" class="glyphicon glyphicon-usd"></span> Descuento Honorarios</a>
									</li>
								</ul>
							</li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							<li class="dropdown">
								<a href="http://<?php echo $vlc_dominio . "/" . $vlc_proyecto; ?>/prealta">
									<div class="text letra_color">
										<span id="icono_menu" class="glyphicon glyphicon-bed"> </span><b> Ingresar Pre-alta</b>
									</div>
								</a>
							</li>
						</ul>
	...
	<div class="container-fluid fondo_nav_bar">
		...
		<button type="button" class="navbar-toggle collapsed icono_color" id="btn_menu_navbar" data-toggle="collapse" data-target="#menu-navbar">
		...
		<label class="texto_migas">
			<?php

			if (strpos($_SERVER['PHP_SELF'], 'pagos_mes.php') !== false) {

				echo "<span class='glyphicon glyphicon-usd'></span> Facturas Pagadas";
			} else if (strpos($_SERVER['PHP_SELF'], 'facturas_mes.php') !== false) {

				echo "<span class='glyphicon glyphicon-duplicate'></span> Facturas Pendientes";
			} else if (strpos($_SERVER['PHP_SELF'], 'cpt.php') !== false) {

				echo "<span class='glyphicon glyphicon-header'></span> CPT";
			} else if (strpos($_SERVER['PHP_SELF'], 'estado_cuenta.php') !== false) {

				echo "<span class='glyphicon glyphicon-download-alt'></span> Estado de Cuenta";
			} else if (strpos($_SERVER['PHP_SELF'], 'prealta.php') !== false) {

				echo "<span class='glyphicon glyphicon-bed'></span> Pre-Alta";
			} else if (strpos($_SERVER['PHP_SELF'], 'inicio.php') !== false) {

				echo "<span class='glyphicon glyphicon-home'></span> Inicio";
			} else if (strpos($_SERVER['PHP_SELF'], 'descuento_honorario.php') !== false) {

				echo "<span class='glyphicon glyphicon-usd'></span> Descuento Honorarios";
			}
			?>
		...
		<div class="modal fade" id="cambiar_contrasena" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title"><span class="glyphicon glyphicon-wrench"></span> Cambiar contraseña</h4>
					</div>

					<div class="modal-body">
						<div id="light_modal" class="preloader_modal" style="display: none;">
							<center>
								<img src="vista/imagen/66.gif">
							</center>
						</div>
	...
	<div class="container-fluid">
		<div class="modal fade" id="mi_perfil" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title"><span id="icono_menu" class="glyphicon glyphicon-user"> </span> Mi perfil</h4>
					</div>

					<div class="modal-body">
						<div id="listar_perfil"></div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
					</div>
...
<script type="text/javascript" src="librerias/sesion/usuario.js"></script>