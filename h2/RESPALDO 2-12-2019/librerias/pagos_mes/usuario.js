...
function generar_clave(vln_proveedor)
	{
		...
		$.ajax(
		{
			url:'http://app.hmetro.med.ec/honorarios/controlador/pagos_mes/usuario.php',
			type:'POST',
		...
		{	
			...
			setTimeout(function(){ window.location="http://app.hmetro.med.ec/honorarios/controlador/sesion/cerrar_sesion.php"; }, 10000);
