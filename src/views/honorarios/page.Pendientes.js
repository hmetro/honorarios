...
const DataProvider = {
    ...
    fetch: () => {
        ...
        m.request({
            method: "GET",
            url: "https://api.hospitalmetropolitano.org/t/v1/honorarios/facturas-pendientes?start=0&length=1000",
            headers: {
            ...
            .then(function (result) {
                ...
                PagePendientesHonorarios.codMedico = PagePendientesHonorarios.codMedico;
                DataProvider.data = result;
                DataProviderInter.data = result;
                            ...
                            m("div.media.",
                                m("div.media-body",
                                    [
                                        ...
                                        m("h6",
                                            "Monto: 703.27 USD Cancelado: 70.32 Saldo: 0 USD "
                                        ),
                                ...
                                m("div.media-body",
                                    [
                                        ...
                                        m("h6",
                                            ...
                                            // Por nombres y apellidos y numero de factura.
                                        ),
...
const PagePendientesHonorarios = {
    codMedico: "",
    oninit: () => {
        Loader.show = "";
        Loader.buttonShow = "";
        PagePendientesHonorarios.codMedico = Auth.codMedico;
        if (!Auth.isLogin()) {
...
export default PagePendientesHonorarios;