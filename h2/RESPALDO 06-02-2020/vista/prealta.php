					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class='table-responsive'>
		        		    	<table class="table letra_tabla_cabecera" >
		        		    		<thead>
		        		    			<tr>
		        		    				<th class="active col-md-1">Buscar</th>
		        		    				<th class="active col-md-2">Código</th>
		        		    				<th class="active col-sm-9 col-xs-9 ancho_tabla_descripcion">Descripción</th>
		        		    				<th class="active col-md-1">Cantidad</th>
		        		    				<th class="active col-md-2">Porcentaje %</th>
		        		    				<th class="active col-md-2">Fecha</th>
		        		    				<th class="active col-md-1">Añadir</th>
		        		    			</tr>
		        		    		</thead>
		        		    		<tbody>
		        		    			<tr>
		        		    				<td align="right"><a class="btn btn-default btn-md" href="#" onclick="busqueda_codigos_cpt('codigo_cpt_1','descripcion_ctp_1');" ><span class="glyphicon glyphicon-search"></span></a></td>
		        		    				<td><input type="number" class="form-control input-sm" name="codigo_cpt_1" id="codigo_cpt_1"></td>
		        		    				<td><input type="text" class="form-control input-sm ancho_tabla_descripcion" name="descripcion_ctp_1" id="descripcion_ctp_1"></td>
		        		    				<td><input type="number" class="form-control input-sm" name="cantidad_cpt_1" id="cantidad_cpt_1" value="1"></td>
		        		    				<td><input type="number" class="form-control input-sm" name="porcentaje_cpt_1" id="porcentaje_cpt_1" value="100"></td>
		        		    				<td><input type="date" class="form-control input-sm" name="fecha_codigo_cpt" id="fecha_codigo_cpt"></td>
		        		    				<td align="left"><button class="btn btn-primary btn-md" onclick="ingreso_codigo_cpt();"><span class="glyphicon glyphicon-plus"></span></button></td>
										</tr>									
									</tbody>
								</table>
		        		   	</div>
