	...
	<body onload="lista_pagos_mes(
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li class="menu_subdatos">
											<a href="#" data-toggle='modal' data-target='#cambiar_contrasena'><span id="icono_menu" class="glyphicon glyphicon-wrench"></span> Cambiar contraseña</a>
										</li>
										<li class="menu_subdatos">
											<a href="http://app.hmetro.med.ec/honorarios/controlador/sesion/cerrar_sesion.php"><span id="icono_menu" class="glyphicon glyphicon-off"></span> Cerrar sesión</a>
										</li>
									</ul>
								</li>
							</ul>
		...
		<div class= "container">
			<div class="panel" id="panel_buscar">
				<div class="panel-heading" id="panel_heading_buscar"><b>Consulta de pagos por mes</b></div>
					<div class="panel-body">
						<div class="row form-horizontal">
							...
							<div class="form-group">	
								<div class="col-xs-offset-4 col-md-6 col-md-offset-5">
		...
		<script src="plugins/cssrefresh/cssrefresh.js"></script>	
