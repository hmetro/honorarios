<?php
    ...
    $vgc_tipo_imprime=$_GET['tipo_imprime'];
    ...
    $dompdf->load_html( file_get_contents( "http://".$vlc_dominio."/".$vlc_proyecto."/controlador/descarga_documentos/imprimir_planilla_pago.php?vgc_proveedor=".$vgc_proveedor."&vgc_fecha_transaccion=".$vgc_fecha_transaccion."&vgn_numero_transaccion=".$vgn_numero_transaccion."&vgc_tipo_imprime=".$vgc_tipo_imprime ) );
    $dompdf->render();
